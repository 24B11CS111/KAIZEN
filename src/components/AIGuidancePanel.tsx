  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span className="grid place-items-center h-9 w-9 rounded-md bg-blood-500/10 border border-blood-500/30 shrink-0">
          <Brain className="h-4 w-4 text-blood-500" />
        </span>
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="text-sm font-semibold">Today\'s focus</h3>
            <span className="text-[9px] uppercase tracking-[0.18em] text-blood-500">AI</span>
          </div>
          ...
          <div className="mt-3 flex items-center gap-2 flex-wrap">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1 text-[11px] text-white/75">
              <Target className="h-3 w-3 text-blood-500" /> {focusArea}
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1 text-[11px] text-white/75">
              <Clock className="h-3 w-3 text-blood-500" /> ~{estimatedMinutes} min
            </span>
          </div>
        </div>
      </div>
